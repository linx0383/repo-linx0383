#CSCI5143 RTOS Assignment Part1_Workload1
#import lcm

#Input of the period set (Workload1)
period_List=[10,10,20,20,40,40,80,80]
WCET_List=[2,2,1,2,2,2,2,2]
offset_List=[0,0,5,5,5,5,10,10]
deadline_List=[10,10,20,20,30,30,60,60]
